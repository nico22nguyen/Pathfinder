# TODO
# - add option to select start, end, obstactles with mouse
...
while running:
    if no_path:
        colors.EXP_COLOR = colors.RED
    else:
        colors.EXP_COLOR = colors.PURPLE
    ...
    for event in pygame.event.get():
        ...
        #mouse click
            ...
            (END is None or not (grid.target.row == row and grid.target.col == col)) and 
